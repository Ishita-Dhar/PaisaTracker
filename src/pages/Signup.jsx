    ...
    <div className='bg-gray-100 min-h-screen flex flex-col justify-between gap-10'>
            ...
            <div className='flex flex-col items-center justify-center gap-5'>
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h3 className='text-gray-600  '>Join PaisaTracker to architect your wealth.</h3>
                </div>
                <form action="" className='w-full max-w-md  mx-auto rounded-xl p-6 sm:p-8 bg-gray-50 flex flex-col gap-6 items-center justify-center  border border-gray-300'>
                    ...
                    <div className='flex flex-col gap-2 w-full '>
                        ...
                        <div className='flex items-center gap-2 px-4 py-3 rounded-lg border border-gray-300'>
                            <FaRegUser className=' text-gray-400' size={25} />
                            <input type="text" name="name" id="" placeholder='Enter your name' className='outline-none w-full bg-transparent text-gray-700' />
                        </div>
                    </div>            
                    <div className='flex flex-col gap-2 w-full '>
                    ...
                    <div className='flex flex-col gap-2 w-full'>
                        <label className='text-sm font-medium text-gray-700 flex justify-between gap-5'>Password </label>
                        <div className='flex items-center gap-2 px-4 py-3 rounded-lg border border-gray-300'>
                    ...
                    <div className='flex flex-col gap-2 w-full'>
                        <label className='text-sm font-medium text-gray-700 flex justify-between gap-5'>Confirm Password </label>
                        <div className='flex items-center gap-2 px-4 py-3 rounded-lg border border-gray-300'>
                            <GoShieldLock className=' text-gray-400' size={25} />
                            <input type="password" placeholder='........' className='outline-none w-full bg-transparent text-gray-700 placeholder:text-3xl placeholder:font-medium ' />
                        </div>
                    </div>
                    <p className='text-xs text-gray-600 mb-5'>
                    By Logging in, you agree to our <a className=' hover:underline text-blue-700 font-bold' href="">Terms of Service</a> and <a className='text-blue-700 hover:underline font-bold' href="">Privacy Policy</a>.
                </p>
                ...
                <p className='text-sm text-gray-600 mb-5'>
                    Already have an account? <a className='text-blue-700 font-bold hover:underline' href="">Signin</a> 
                </p>
