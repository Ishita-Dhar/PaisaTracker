...
const Navbar = () => {
    return (
        <div className='w-full flex  sm:flex-row justify-between items-center px-6 sm:px-10 py-2 border-b border-gray-300 bg-gray-50'>
            ...
            <div className='hidden md:flex bg-blue-100 hover:bg-blue-200 w-1/2 px-5 py-2 mr-5 rounded-lg justify-start items-center gap-5 text-gray-500 '><FaSearch /> <input type="text" placeholder='Search transactions, tags....' className='outline-none w-full' />
            </div>
