...
const Footer = () => {
  return (
    <div className='w-full flex flex-col sm:flex-row justify-between items-center gap-4 px-6 sm:px-10 py-4 sm:py-8 mt-auto  bg-gray-50 border-t border-gray-300'> 
